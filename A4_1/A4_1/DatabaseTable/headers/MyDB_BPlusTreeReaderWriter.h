...
private:
	...
	MyDB_RecordPtr append (int page, MyDB_RecordPtr appendMe);
...
//    shared_ptr <MyDB_PageReaderWriter> root;
    MyDB_PageReaderWriterPtr root;
    
    void initialize();
    
    MyDB_PageReaderWriterPtr getByID(int index);
    
    void sortPage(MyDB_PageReaderWriterPtr page);
